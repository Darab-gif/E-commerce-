...
const Contact = () => {
  return (
    <div className="contact-head">
      <div style={{ marginLeft: "100px" }} className="contact-sub">
      ...
      <div style={{ marginRight: "30px" }} className="contact-sub">
        <span className="span-mail">
          <FontAwesomeIcon icon={faMailBulk} size="2x" />
        </span>
        <h2 style={{ textAlign: "center", marginRight: "120px" }}>Email</h2>
        <p style={{ marginRight: "70px" }}>rdapoahmid@gmail.com</p>
      </div>
    </div>
  );
};
